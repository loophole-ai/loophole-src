	...
	registry.registerConfiguration({
		...
		'properties': {
			...
			'workbench.sideBar.location': {
				...
				'enum': ['left', 'right'],
				'default': 'left',
				'description': localize('sideBarLocation', "Controls the location of the primary side bar and activity bar. They can either show on the left or right of the workbench. The Loophole side bar will show on the opposite side of the workbench.")
			},
